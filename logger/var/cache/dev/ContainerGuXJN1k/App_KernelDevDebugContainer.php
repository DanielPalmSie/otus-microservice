...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\LoggingController' => 'getLoggingControllerService',
            ...
            'old_sound_rabbit_mq.add_posts_consumer' => 'getOldSoundRabbitMq_AddPostsConsumerService',
            'old_sound_rabbit_mq.add_posts_producer' => 'getOldSoundRabbitMq_AddPostsProducerService',
    ...
    protected function getDebug_Security_FirewallService()
    {
        ...
        }, 4)), $b, new \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService())));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\User\\UserProvider'] ?? $this->load('getUserProviderService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'old_sound_rabbit_mq.base_amqp' => [
                0 => 'old_sound_rabbit_mq.add_posts_producer',
                1 => 'old_sound_rabbit_mq.add_posts_consumer',
            ],
            'console.command.ids' => [
