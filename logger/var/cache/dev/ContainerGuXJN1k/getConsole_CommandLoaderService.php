...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Command\\LoadFeedDataCommand' => ['privates', 'App\\Command\\LoadFeedDataCommand', 'getLoadFeedDataCommandService', true],
            ...
            'App\\Command\\LoadFeedDataCommand' => 'App\\Command\\LoadFeedDataCommand',
        ...
        ]), ['app:load-feed-data' => 'App\\Command\\LoadFeedDataCommand', 'about' => 'console.command.about', 'assets:install' => 'console.command.assets_install', 'cache:clear' => 'console.command.cache_clear', 'cache:pool:clear' => 'console.command.cache_pool_clear', 'cache:pool:prune' => 'console.command.cache_pool_prune', 'cache:pool:invalidate-tags' => 'console.command.cache_pool_invalidate_tags', 'cache:pool:delete' => 'console.command.cache_pool_delete', 'cache:pool:list' => 'console.command.cache_pool_list', 'cache:warmup' => 'console.command.cache_warmup', 'debug:config' => 'console.command.config_debug', 'config:dump-reference' => 'console.command.config_dump_reference', 'debug:container' => 'console.command.container_debug', 'lint:container' => 'console.command.container_lint', 'debug:autowiring' => 'console.command.debug_autowiring', 'debug:dotenv' => 'console.command.dotenv_debug', 'debug:event-dispatcher' => 'console.command.event_dispatcher_debug', 'debug:router' => 'console.command.router_debug', 'router:match' => 'console.command.router_match', 'lint:yaml' => 'console.command.yaml_lint', 'secrets:set' => 'console.command.secrets_set', 'secrets:remove' => 'console.command.secrets_remove', 'secrets:generate-keys' => 'console.command.secrets_generate_key', 'secrets:list' => 'console.command.secrets_list', 'secrets:decrypt-to-local' => 'console.command.secrets_decrypt_to_local', 'secrets:encrypt-from-local' => 'console.command.secrets_encrypt_from_local', 'debug:firewall' => 'security.command.debug_firewall', 'security:hash-password' => 'security.command.user_password_hash', 'lexik:jwt:check-config' => 'lexik_jwt_authentication.check_config_command', 'lexik:jwt:migrate-config' => 'lexik_jwt_authentication.migrate_config_command', 'lexik:jwt:enable-encryption' => 'lexik_jwt_authentication.enable_encryption_config_command', 'lexik:jwt:generate-token' => 'lexik_jwt_authentication.generate_token_command', 'lexik:jwt:generate-keypair' => 'lexik_jwt_authentication.generate_keypair_command', 'rabbitmq:anon-consumer' => 'old_sound_rabbit_mq.anon_consumer_command', 'rabbitmq:batch:consumer' => 'old_sound_rabbit_mq.batch_consumer_command', 'rabbitmq:consumer' => 'old_sound_rabbit_mq.consumer_command', 'rabbitmq:delete' => 'old_sound_rabbit_mq.delete_command', 'rabbitmq:dynamic-consumer' => 'old_sound_rabbit_mq.dynamic_consumer_command', 'rabbitmq:multiple-consumer' => 'old_sound_rabbit_mq.multiple_consumer_command', 'rabbitmq:purge' => 'old_sound_rabbit_mq.purge_consumer_command', 'rabbitmq:rpc-server' => 'old_sound_rabbit_mq.command.rpc_server_command', 'rabbitmq:setup-fabric' => 'old_sound_rabbit_mq.command.setup_fabric_command', 'rabbitmq:stdin-producer' => 'old_sound_rabbit_mq.command.std_in_producer_command']);
    }
}
