...
require_once __DIR__.\DIRECTORY_SEPARATOR.'BatchConsumersConfig'.\DIRECTORY_SEPARATOR.'OptionsConfig.php';
...
class BatchConsumersConfig 
{
    ...
    public function options(array $value = []): \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\OptionsConfig
    {
        if (null === $this->options) {
            $this->_usedProperties['options'] = true;
            $this->options = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\OptionsConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('options', $value)) {
            $this->_usedProperties['options'] = true;
            $this->options = new \Symfony\Config\OldSoundRabbitMq\BatchConsumersConfig\OptionsConfig($value['options']);
            unset($value['options']);
        }
